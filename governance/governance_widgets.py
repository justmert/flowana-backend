...
class GovernanceWidgets:
    ...
    def voting_power_chart(self, **kwargs):
        ...
        for interval in self.VotingPowerInterval:
            ...
            variables = {
                ...
                "weightChangesSort": {"field": "CREATED", "order": "DESC"},
    ...
    def delegates(self, **kwargs):
        ...
        for order_by in self.DelegateSortField:
            ...
            for delegate in delegates:
                ...
                delegate["account"][
                    "tally_url"
                ] = f"https://www.tally.xyz/profile/{delegate['account']['address']}?governanceId={self.governance_id}"
    ...
    def proposals(self, **kwargs):
        ...
        for proposal in proposals:
            ...
            proposal["proposer"][
                "tally_url"
            ] = f"https://www.tally.xyz/profile/{proposal['proposer']['address']}?governanceId={self.governance_id}"
    ...
    def safes(self, **kwargs):
        data = self.actor.governance_rest_make_request(
            url=f"/safes?organizationId={self.organization_id}",
            max_page_fetch=1,
        )
